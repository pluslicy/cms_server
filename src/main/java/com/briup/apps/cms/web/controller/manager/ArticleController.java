...
public class ArticleController {
	...
	public MsgResponse findArticle(int page,int pageSize,Long categoryId,String keywords) {
		try {
			PageVM<ArticleVM> pageVM=  articleService.queryArticle(page	, pageSize, categoryId, keywords);
